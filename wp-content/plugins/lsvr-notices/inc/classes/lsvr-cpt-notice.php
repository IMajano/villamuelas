    ...
    class Lsvr_CPT_Notice extends Lsvr_CPT {
		...
		public function __construct() {
			...
			parent::__construct( array(
				...
				'wp_args' => array(
					'labels' => array(
						'name' => esc_html__( 'Bandos', 'lsvr-notices' ),
						'singular_name' => esc_html__( 'Bando', 'lsvr-notices' ),
						'add_new' => esc_html__( 'Añadir Nuevo Bando', 'lsvr-notices' ),
						'add_new_item' => esc_html__( 'Añadir Nuevo Bando', 'lsvr-notices' ),
						'edit_item' => esc_html__( 'Editar Bando', 'lsvr-notices' ),
						'new_item' => esc_html__( 'Añadir Nuevo Bando', 'lsvr-notices' ),
						'view_item' => esc_html__( 'Ver Bando', 'lsvr-notices' ),
						'search_items' => esc_html__( 'Buscar bandos', 'lsvr-notices' ),
						'not_found' => esc_html__( 'No hay bandos', 'lsvr-notices' ),
						'not_found_in_trash' => esc_html__( 'No se han encontrado bandos en la papelera', 'lsvr-notices' ),
					),
			...
			$this->add_taxonomy(array(
				...
				'wp_args' => array(
					'labels' => array(
						'name' => esc_html__( 'Tipos de bandos', 'lsvr-notices' ),
						'singular_name' => esc_html__( 'Tipo de bando', 'lsvr-notices' ),
						'search_items' => esc_html__( 'Buscar Tipos de bandos', 'lsvr-notices' ),
						'popular_items' => esc_html__( 'Tipos de bandos más consultados', 'lsvr-notices' ),
						'all_items' => esc_html__( 'Todas los tipos de bandos', 'lsvr-notices' ),
						'parent_item' => esc_html__( 'Padre del tipo de bandos', 'lsvr-notices' ),
						...
						'menu_name' => esc_html__( 'Tipos de bandos', 'lsvr-notices' )
					),
					'public' => true,
					'show_in_nav_menus' => true,
					'show_ui' => true,
