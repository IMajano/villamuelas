    ...
    public function __construct() {
		...
		parent::__construct(array(
			...
			'fields' => array(
				...
				'show_time' => array(
					'label' => esc_html__( 'Ver la hora local', 'lsvr-townpress-toolkit' ),
        ...
        <div class="widget__content">
			...
			if ( true === $show_time ) : ?>
				...
				<div class="lsvr-townpress-weather-widget__time">
					<h4 class="lsvr-townpress-weather-widget__time-title"><?php esc_html_e( 'Hora local', 'lsvr-townpress-toolkit' ); ?></h4>
						...
						<li class="lsvr-townpress-weather-widget__weather-item lsvr-townpress-weather-widget__weather-item--current">
							<div class="lsvr-townpress-weather-widget__weather-item-labels">
								<h4 class="lsvr-townpress-weather-widget__weather-item-title">
									<?php esc_html_e( 'Hoy', 'lsvr-townpress-toolkit' ); ?>
								</h4>
