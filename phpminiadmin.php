...
$ACCESS_PWD=getenv("DB_PASS"); #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

#DEFAULT db connection settings
# --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
$DBDEF=array(
'user'=>getenv("DB_USER"),#required
'pwd'=>getenv("DB_PASS"), #required
'db'=>getenv("DB_PASS"),  #optional, default DB
'host'=>getenv("MYSQL_SERVICE_HOST"),#optional
'port'=>"3306",#optional
'socket'=>"",#optional
